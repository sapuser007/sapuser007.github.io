...
sap.ui.define([
	...
	return BaseController.extend("LMES.CovidTracker2021.controller.Slots", {
		...
		onSwitch: function (oSwitch) {
			debugger;
			var filterSelection = oSwitch.getParameters().state;
			if (filterSelection === false) {
				var aFilter = new Filter({
					and: false,
					filters: [
						new Filter("sessions/0/available_capacity_dose1", FilterOperator.GT, 0),
						new Filter("sessions/0/available_capacity_dose2", FilterOperator.GT, 0)
					]
